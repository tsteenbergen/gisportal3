...
$test2.='<tr><td>Persistent storage vlgs Openshift:</td><td></td><td style="text-align: right;">'.($memory->persistent_afk!='ERROR-NO-PERSITENT-STORAGE-FOUND'?$memory->persistent_afk:wrapError('Not retrieved')).'</td></tr>';
if ($memory->persistent_afk!='ERROR-NO-PERSITENT-STORAGE-FOUND') {
...
$test2.='<tr><td>Root map /geo-logs:</td><td></td><td style="text-align: right;">'.(file_exists($basicPage->getConfig('geo-logs'))?'Exists':wrapError('Does not exist')).'</td></tr>';
$test2.='<tr><td>&nbsp;</td></tr>';
