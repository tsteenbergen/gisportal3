...
$test2.='<tr><td>Persistent storage vlgs Openshift:</td><td></td><td style="text-align: right;">'.($memory->persistent_afk>' '?$memory->persistent_afk:wrapError('Not retrieved')).'</td></tr>';
