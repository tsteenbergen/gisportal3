	...
	if (isset($_GET['id'])) {
		...
		if ($func=='delete') {
			...
			if ($ver) {
				...
				$r.='<tr><td>Upload files:</td><td><textarea name="extensions" rows="6" cols="32">'.$ver['extensions'].'</textarea><br>Format per regel:&nbsp;&nbsp;&nbsp;ext[/ext[/ext...]] [O][K][=&hellip;]<table><tr><td>ext/ext</td><td>&eequ;&eequ;n van deze extenties</td></tr><tr><td>O</td><td>Deze extentie is optioneel</td></tr><tr><td>K</td><td>Na upload wordt de KAARTNAAM voor de file gebruikt (de extentie blijft gelijk)</td></tr><tr><td>=&hellip;</td><td>Na upload wordt de &hellip; voor de file gebruikt (de extentie blijft gelijk)</td></tr></table></td></tr>';
